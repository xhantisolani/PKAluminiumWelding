...
export default function Services() {
  ...
  return (
    <Box bg={bgColor} color={useColorModeValue('gray.800', 'gray.100')}>
      ...
      {/* ------------------------------------- */}
      <Box bg="gray.800" py={{ base: 20, md: 32 }} color="white">
        <Container maxW="7xl">
          <MotionHeading
          ...
          >
            PK Aluminium is your specialist partner for durable, custom-engineered aluminium structures. We focus on **uncompromising quality** and **architectural aesthetics** for commercial and residential clients in the Western Cape.
          </MotionText>
        </Container>
      </Box>
      ...
      <Box py={{ base: 16, md: 24 }} bg="white">
        <Container maxW="7xl">
          <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={12} alignItems="center">
            ...
            <MotionImage
              src="/images/tig-welding-detail.jpg" // High-detail image of TIG welding or a perfect weld bead
              alt="Close up of precision TIG welding"
              rounded="2xl"
              shadow="2xl"
              initial={{ opacity: 0, scale: 0.9 }}
              whileInView={{ opacity: 1, scale: 1 }}
      ...
      {/* ------------------------------------- */}
      {/* 4. OTHER SUPPORT SERVICES (Service Card Grid) */}
      {/* ------------------------------------- */}
      <Container maxW="7xl" py={{ base: 16, md: 24 }}>
        <MotionHeading
          size="xl"
