...
// Updated FAQ Data with <strong> tags and NEW QUESTIONS
const faqData = [
  {
  ...
  // --- NEW PRODUCT-SPECIFIC FAQS ADDED HERE ---
  {
    q: 'What is the benefit of an aluminium Bakkie Drawer System or Roof Rack over steel?',
    a: 'The key advantage is **weight and corrosion resistance**. Aluminium bakkie systems (drawers, roof racks, and cattle rails) are significantly **lighter** than steel, which preserves your vehicle’s payload capacity, improves fuel economy, and reduces stress on the suspension. They are also 100% **rust-proof**, making them ideal for any environment, from harsh farm roads to coastal transport.',
    category: 'Product Specific',
  },
  {
    q: 'Can you custom-build security items like gates, burglar bars, and window frames to specific designs?',
    a: 'Yes, custom fabrication is our specialty. We work with both homeowners and architects to create **secure, architecturally compliant gates, burglar bars (burglars), and window frames**. We don’t just offer standard designs; we craft unique solutions that match your property’s aesthetic while providing maximum security and adhering to all local building codes.',
    category: 'Product Specific',
  },
  {
    q: 'Do you fabricate custom trailers, and what materials are used?',
    a: 'We build **custom aluminium trailers** for various applications (utility, luggage, specialised equipment). We use lightweight, high-strength aluminium for the chassis and structure, which provides **exceptional durability** and is **immune to rust**, making the trailer last far longer than traditional steel alternatives while also being easier to tow.',
    category: 'Product Specific',
  },
];
...
export default function FAQ() {
  ...
  const seoTitle = "FAQ: Custom Aluminium Welding, Fabrication & Lead Times | PK Aluminium";
  const seoDescription = "Find answers to frequently asked questions about our TIG welding process, aluminium suitability for coastal Cape Town, lead times, quote requirements, and product warranties, including details on automotive and security fabrication."; // Updated SEO Description
  ...
  return (
    <Box bg={useColorModeValue('gray.50', 'gray.900')} color={useColorModeValue('gray.800', 'gray.100')}>
        ...
        <SeoHead
            ...
            path="faq" // Sets the canonical URL to /faq
            ogImage="logo.jpg"
        />
        {/* --- END SEO --- */}
